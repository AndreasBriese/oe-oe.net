    /*
     * BLAKE2s
     * constant time comparison added
     * see https://blake2.net for the original algorithm
     * deigned by Aumasson, Neves, Wilcox-O'Hearn, Winnerlein
     * Javascript written in 2012-2014 by Dmitry Chestnykh.
    ...
    0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19]);
        ...
        function BLAKE2s(digestLength, key) {
            ...
            if (typeof key === 'string') throw new TypeError('key must be a Uint8Array or an Array of bytes');
        ...
        BLAKE2s.prototype.equal = function (hashToCompare) {
            if (!this.isFinished) this.digest();
            var e = this.digestLength != hashToCompare.length;
            if (!e) {
                for (var i = hashToCompare.length; i > 0; e |= hashToCompare[--i] ^ this.result[i]) {}
                return e === 0;
            } else return false;
        };
